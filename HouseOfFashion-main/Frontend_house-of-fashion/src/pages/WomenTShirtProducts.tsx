...
const WomenTShirtProducts: React.FC = () => {
  const {data,isFetching} = useGetWomenClothesByTypeQuery({type:'T-Shirt'})
        ...
        <CenterPage>
          {
            ...
            {data?.map((product, index) => (
              <ProductCard
                ...
                image={`/jpg/womenshirt${index+1}.jpg`}
                title={product.title}
                price={product.price}
...
export default WomenTShirtProducts;
